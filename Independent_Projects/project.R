...
library(xlsx)
library(readxl)
excel_sheets('https://raw.githubusercontent.com/Devesan/Stats_R_code/main/Datasets/data_academic_performance.xlsx')
s_perform<-read_excel('https://raw.githubusercontent.com/Devesan/Stats_R_code/main/Datasets/data_academic_performance.xlsx',sheet = 'SABER11_SABERPRO')
head(s_perform)
summary(s_perform)
str(s_perform)
